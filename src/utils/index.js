...
export function mapTo(keys: Array<string | number>, keyFn: any => string | number) {
...
export function mapToMany(keys: Array<string | number>, keyFn: any => string | number) {
  return (rows: Array<any>) => {
...
export function mapToValues(keys: Array<string | number>, keyFn: any => string | number, valueFn: any => any) {
  return (rows: Array<any>) => {
    const group = new Map(keys.map(key => [key, null]));
